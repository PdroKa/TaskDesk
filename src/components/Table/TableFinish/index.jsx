...
export const TableFinish = ({ currentItens, handleInfoOpen, ordenarPor, colunaOrdenada, ordem }) => {
    const finish = "TableFinish"
    return (
        <>
            <thead>
                <tr>
            ...
            <tbody>
                {
                    currentItens.map((user) => <TableMapUser handleInfoOpen={handleInfoOpen} finish={finish} key={user.id} props={user} />)
                }
            </tbody>
        </>
